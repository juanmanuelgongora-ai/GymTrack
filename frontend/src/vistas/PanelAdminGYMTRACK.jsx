...
const PanelAdminGYMTRACK = ({ onLogout }) => {
    ...
    React.useEffect(() => {
        const fetchPendientesCount = async () => {
            try {
                ...
                const res = await fetch('/api/admin/entrenadores/pendientes', {
                    headers: {
    ...
    const renderTabContent = () => {
        switch (activeTab) {
            ...
            case 'solicitudes': return <SolicitudesEntrenadorTab />;
    ...
    return (
        <div style={{
            backgroundImage: `linear-gradient(rgba(13, 13, 13, 0.85), rgba(13, 13, 13, 0.95)), url('/C:/Users/Usuario/.gemini/antigravity/brain/4e766b73-8a33-4081-95e0-43459b6c2061/premium_gym_background_v2_1778009024209.png')`,
            ...
            <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                ...
                <div className="glass-panel" style={{
                    ...
                    <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
                        <div style={{ position: 'relative', cursor: 'pointer' }} onClick={() => setActiveTab('solicitudes')}>
                            <div className="glass-panel" style={{
                                padding: '12px',
                                borderRadius: '12px',
