...
const Icons = {
    ...
    Dumbbell: () => <svg width="32" height="32" viewBox="0 0 24 24" fill="white" stroke="white" strokeWidth="2"><path d="M6.5 6.5L17.5 17.5M18.5 14L21.5 17L17.5 21L14.5 18M3.1 7.1L6.1 10.1L10.1 6.1L7.1 3.1M16 5.5L19 2.5L22 5.5L19 8.5M2.5 19L5.5 16L8.5 19L5.5 22"></path></svg>,
